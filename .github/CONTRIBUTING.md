...
Each commit message consists of a header, and an optional body and footer. The header has a special format that includes a type, an optional scope and a subject:
...
* no dot (.) at the end
* an issue reference e.g. SDK-1234 can be added to the end of the subject
