...
internal class CampaignsListManager: CampaignsListManagerType, TaskSchedulable {
    ...
    private func handleError(_ error: Error) {
        ...
        case MessageMixerServiceError.invalidConfiguration:
            eventLogger.logEvent(eventType: .critical, errorCode: Constants.RMCErrorCode.pingInvalidConfig, errorMessage: "Error retrieving InAppMessaging Mixer Server URL")
        ...
        case MessageMixerServiceError.jsonDecodingError(let decodingError):
            eventLogger.logEvent(eventType: .warning, errorCode: Constants.RMCErrorCode.pingDecodingError, errorMessage: "Ping request error: Failed to parse json")
